 ...
 * @return void
 */
function tagwall_taxonomy_film_type_add_meta_fields( $tag ) {
	$term_id   = $tag->term_id;
	$term_meta = get_option( "taxonomy_term_$term_id" ); ?>
	<tr class="form-field">
		<th scope="row" style="vertical-align: middle;">
	...
	<tr class="form-field">
		<th scope="row" style="vertical-align: middle;">
			<label for="term_meta[portfolio_link]"><?php _e( 'Portfolio Link' ); ?></label>
		</th>
		<td>
			<textarea id="term_meta[portfolio_link]" name="term_meta[portfolio_link]"><?php echo $term_meta['portfolio_link']; ?></textarea>
			<p class="description"><?php _e( 'Add an image URL to associate with the taxonomy term.' ); ?></p>
		</td>
	</tr><?php
}
add_action( 'film_type_edit_form_fields', 'tagwall_taxonomy_film_type_add_meta_fields', 10, 2 );
 ...
 * @return void
 */
function tagwall_taxonomy_save_meta_fields( $term_id ) {
...
add_action( 'edited_panel', 'tagwall_taxonomy_save_meta_fields', 10, 2 );
add_action( 'edited_hardware_type', 'tagwall_taxonomy_save_meta_fields', 10, 2 );
add_action( 'edited_glass_type', 'tagwall_taxonomy_save_meta_fields', 10, 2 );
add_action( 'edited_film_type', 'tagwall_taxonomy_save_meta_fields', 10, 2 );
